                ...
                if (event == "telemetry") {
                    ...
                    for (int i = 0; i < sensor_fusion.size(); i++) {
                        ...
                        //if (d < (2 + 4 * lane + 2) && d > (2 + 4 * lane - 2)) {
                            ...
                            } else if (car_lane - lane == -1) // car is on the left
                            {
                                car_left |= (car_s - SAFE_DIST < check_car_s) && (car_s + SAFE_DIST > check_car_s);

                            } else if (car_lane - lane == 1) // car is on the right
                            {
                        ...
                        //}
                            ...
                            for(int i=0;i<50;i++)
                            {
                                ...
                                double next_d = 6; // 1.2 times the width of the Car lane which is  4 
